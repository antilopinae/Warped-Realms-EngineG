...
template <typename T, std::size_t Extent>
class Span {
    static_assert(Extent == dynamic_extent, "The current implementation supports dynamic-extent span only");
...
public:
    ...
    template <
        typename C,
        std::enable_if_t<!IsSpan<C>::value && std::is_pointer_v<decltype(std::declval<C&>().data())> &&
                             std::is_convertible_v<std::remove_pointer_t<decltype(std::declval<C&>().data())> (*)[], T (*)[]> &&
                             std::is_convertible_v<decltype(std::declval<C>().size()), std::size_t>,
                         int> = 0>
...
class PoolAllocationConfig {
    ...
    struct deleter {
        void operator()(wasmtime_pooling_allocation_config_t* p) const { wasmtime_pooling_allocation_config_delete(p); }
    };
...
public:
    ...
    void max_unused_warm_slots(uint32_t max) { wasmtime_pooling_allocation_config_max_unused_warm_slots_set(ptr.get(), max); }
    ...
    void decommit_batch_size(size_t batch_size) {
        wasmtime_pooling_allocation_config_decommit_batch_size_set(ptr.get(), batch_size);
    }
    ...
    void async_stack_keep_resident(size_t size) {
        wasmtime_pooling_allocation_config_async_stack_keep_resident_set(ptr.get(), size);
    }
    ...
    void linear_memory_keep_resident(size_t size) {
        wasmtime_pooling_allocation_config_linear_memory_keep_resident_set(ptr.get(), size);
    }
    ...
    void table_keep_resident(size_t size) { wasmtime_pooling_allocation_config_table_keep_resident_set(ptr.get(), size); }
    ...
    void total_component_instances(uint32_t count) {
        wasmtime_pooling_allocation_config_total_component_instances_set(ptr.get(), count);
    }
    ...
    void max_component_instance_size(size_t size) {
        wasmtime_pooling_allocation_config_max_component_instance_size_set(ptr.get(), size);
    }
    ...
    void max_core_instances_per_component(uint32_t count) {
        wasmtime_pooling_allocation_config_max_core_instances_per_component_set(ptr.get(), count);
    }
    ...
    void max_memories_per_component(uint32_t count) {
        wasmtime_pooling_allocation_config_max_memories_per_component_set(ptr.get(), count);
    }
    ...
    void max_tables_per_component(uint32_t count) {
        wasmtime_pooling_allocation_config_max_tables_per_component_set(ptr.get(), count);
    }
    ...
    void total_memories(uint32_t count) { wasmtime_pooling_allocation_config_total_memories_set(ptr.get(), count); }
    ...
    void total_tables(uint32_t count) { wasmtime_pooling_allocation_config_total_tables_set(ptr.get(), count); }
    ...
    void total_stacks(uint32_t count) { wasmtime_pooling_allocation_config_total_stacks_set(ptr.get(), count); }
    ...
    void total_core_instances(uint32_t count) { wasmtime_pooling_allocation_config_total_core_instances_set(ptr.get(), count); }
    ...
    void max_core_instance_size(size_t size) { wasmtime_pooling_allocation_config_max_core_instance_size_set(ptr.get(), size); }
    ...
    void max_tables_per_module(uint32_t tables) {
        wasmtime_pooling_allocation_config_max_tables_per_module_set(ptr.get(), tables);
    }
    ...
    void table_elements(size_t elements) { wasmtime_pooling_allocation_config_table_elements_set(ptr.get(), elements); }
    ...
    void max_memories_per_module(uint32_t memories) {
        wasmtime_pooling_allocation_config_max_memories_per_module_set(ptr.get(), memories);
    }
    ...
    void max_memory_size(size_t bytes) { wasmtime_pooling_allocation_config_max_memory_size_set(ptr.get(), bytes); }
    ...
    void total_gc_heaps(uint32_t count) { wasmtime_pooling_allocation_config_total_gc_heaps_set(ptr.get(), count); }
};
...
public:
    ...
    void debug_info(bool enable) { wasmtime_config_debug_info_set(ptr.get(), enable); }
    ...
    void epoch_interruption(bool enable) { wasmtime_config_epoch_interruption_set(ptr.get(), enable); }
    ...
    void consume_fuel(bool enable) { wasmtime_config_consume_fuel_set(ptr.get(), enable); }
    ...
    void max_wasm_stack(size_t stack) { wasmtime_config_max_wasm_stack_set(ptr.get(), stack); }
    ...
    void wasm_threads(bool enable) { wasmtime_config_wasm_threads_set(ptr.get(), enable); }
    ...
    void wasm_reference_types(bool enable) { wasmtime_config_wasm_reference_types_set(ptr.get(), enable); }
    ...
    void wasm_simd(bool enable) { wasmtime_config_wasm_simd_set(ptr.get(), enable); }
    ...
    void wasm_bulk_memory(bool enable) { wasmtime_config_wasm_bulk_memory_set(ptr.get(), enable); }
    ...
    void wasm_multi_value(bool enable) { wasmtime_config_wasm_multi_value_set(ptr.get(), enable); }
    ...
    void wasm_function_references(bool enable) { wasmtime_config_wasm_function_references_set(ptr.get(), enable); }
    ...
    void parallel_compilation(bool enable) { wasmtime_config_parallel_compilation_set(ptr.get(), enable); }
    ...
    void strategy(Strategy strategy) { wasmtime_config_strategy_set(ptr.get(), static_cast<wasmtime_strategy_t>(strategy)); }
    ...
    void cranelift_debug_verifier(bool enable) { wasmtime_config_cranelift_debug_verifier_set(ptr.get(), enable); }
    ...
    void cranelift_opt_level(OptLevel level) {
        wasmtime_config_cranelift_opt_level_set(ptr.get(), static_cast<wasmtime_opt_level_t>(level));
    }
    ...
    void memory_reservation(size_t size) { wasmtime_config_memory_reservation_set(ptr.get(), size); }
    ...
    void memory_guard_size(size_t size) { wasmtime_config_memory_guard_size_set(ptr.get(), size); }
...
public:
    ...
    explicit Engine(Config config) : ptr(wasm_engine_new_with_config(config.ptr.release())) {}
...
public:
    ...
    /// size.
    explicit MemoryType(uint32_t min) : MemoryType(wasmtime_memorytype_new(min, false, 0, false, false)) {}

    /// Creates a new 32-bit wasm memory type with the specified minimum number of
    /// pages for the minimum size, and maximum number of pages for the max size.
    MemoryType(uint32_t min, uint32_t max) : MemoryType(wasmtime_memorytype_new(min, true, max, false, false)) {}

    /// Same as the `MemoryType` constructor, except creates a 64-bit memory.
    static MemoryType New64(uint64_t min) { return MemoryType(wasmtime_memorytype_new(min, false, 0, true, false)); }
...
public:
    ...
    public:
        ...
        bool is_mutable() const { return wasm_globaltype_mutability(ptr) == WASM_VAR; }
...
public:
    ...
    FuncType(std::initializer_list<ValType> params, std::initializer_list<ValType> results) : ref(nullptr) {
...
public:
    ...
    explicit Trap(std::string_view msg) : Trap(wasmtime_trap_new(msg.data(), msg.size())) {}
...
template <typename T>
using TrapResult = Result<T, TrapError>;
...
public:
    ...
    static Result<Module> deserialize_file(Engine& engine, const std::string& path) {
        wasmtime_module_t* ret = nullptr;
        auto* error = wasmtime_module_deserialize_file(engine.ptr.get(), path.c_str(), &ret);
        if (error != nullptr) {
            return Error(error);
        }
        return Module(ret);
...
public:
    ...
    /// configuration.
    [[nodiscard]] bool stdin_file(const std::string& path) { return wasi_config_set_stdin_file(ptr.get(), path.c_str()); }
    ...
    /// written there.
    [[nodiscard]] bool stdout_file(const std::string& path) { return wasi_config_set_stdout_file(ptr.get(), path.c_str()); }
    ...
    /// written there.
    [[nodiscard]] bool stderr_file(const std::string& path) { return wasi_config_set_stderr_file(ptr.get(), path.c_str()); }
    ...
    [[nodiscard]] bool preopen_dir(const std::string& path, const std::string& guest_path, size_t dir_perms, size_t file_perms) {
...
class Store {
    ...
    static void finalizer(void* ptr) { std::unique_ptr<std::any> _ptr(static_cast<std::any*>(ptr)); }

public:
    /// Creates a new `Store` within the provided `Engine`.
    explicit Store(Engine& engine) : ptr(wasmtime_store_new(engine.ptr.get(), nullptr, finalizer)) {}
    ...
    public:
        ...
        void set_epoch_deadline(uint64_t ticks_beyond_current) { wasmtime_context_set_epoch_deadline(ptr, ticks_beyond_current); }
...
public:
    ...
    template <typename T>
    explicit ExternRef(Store::Context cx, T val) {
    ...
    std::any& data(Store::Context cx) { return *static_cast<std::any*>(wasmtime_externref_data(cx.ptr, &val)); }
...
struct V128 {
    ...
    V128(const wasmtime_v128& v) : v128{} { memcpy(&v128[0], &v[0], sizeof(wasmtime_v128)); }
};
...
inline Store::Context::Context(Caller& caller) : Context(wasmtime_caller_context(caller.ptr)) {
}
...
#define NATIVE_WASM_TYPE(native, valkind, field)                                       \
    template <>                                                                        \
    struct WasmType<native> {                                                          \
        static const bool valid = true;                                                \
        static const ValKind kind = ValKind::valkind;                                  \
        static void store(Store::Context cx, wasmtime_val_raw_t* p, const native& t) { \
            p->field = t;                                                              \
        }                                                                              \
...
struct WasmType<std::optional<ExternRef>> {
    ...
    static void store(Store::Context cx, wasmtime_val_raw_t* p, const std::optional<ExternRef>& ref) {
        if (ref) {
    ...
    static std::optional<ExternRef> load(Store::Context cx, wasmtime_val_raw_t* p) {
        if (p->externref == 0) {
            return std::nullopt;
        }
        wasmtime_externref_t val;
...
struct WasmTypeList {
    ...
    static bool matches(ValType::ListRef types) { return WasmTypeList<std::tuple<T>>::matches(types); }

    static void store(Store::Context cx, wasmtime_val_raw_t* storage, const T& t) { WasmType<T>::store(cx, storage, t); }

    static T load(Store::Context cx, wasmtime_val_raw_t* storage) { return WasmType<T>::load(cx, storage); }
...
struct WasmTypeList<std::monostate> {
    ...
    static void store(Store::Context cx, wasmtime_val_raw_t* storage, const std::monostate& t) {}

    static std::monostate load(Store::Context cx, wasmtime_val_raw_t* storage) { return std::monostate(); }
...
struct WasmTypeList<std::tuple<T...>> {
    ...
    static void store(Store::Context cx, wasmtime_val_raw_t* storage, const std::tuple<T...>& t) {
        size_t n = 0;
        std::apply(
            [&](const auto&... val) {
...
template <>
struct WasmHostRet<std::monostate> : public WasmHostRet<void> {};
...
struct WasmHostFunc<R (*)(A...)> {
    ...
    static std::optional<Trap> invoke(F& f, Caller cx, wasmtime_val_raw_t* raw) {
        ...
        return std::apply([&](const auto&... val) { return WasmHostRet<R>::invoke(f, cx, raw, val...); }, params);
    }
};
...
struct WasmHostFunc<R (*)(Caller, A...)> : public WasmHostFunc<R (*)(A...)> {
    ...
    static std::optional<Trap> invoke(F& f, Caller cx, wasmtime_val_raw_t* raw) {
        ...
        return std::apply([&](const auto&... val) { return WasmHostRet<R>::invoke(f, cx, raw, cx, val...); }, params);
    }
};
...
/// parameter.
template <typename R, typename C, typename... A>
struct WasmHostFunc<R (C::*)(Caller, A...)> : public WasmHostFunc<R (*)(Caller, A...)> {};

/// Function type information, but as a host const method with a `Caller`
/// first parameter.
template <typename R, typename C, typename... A>
struct WasmHostFunc<R (C::*)(Caller, A...) const> : public WasmHostFunc<R (*)(Caller, A...)> {};

/// Base type information for host callables being used as wasm
/// functions
template <typename T>
struct WasmHostFunc<T, std::void_t<decltype(&T::operator())>> : public WasmHostFunc<decltype(&T::operator())> {};
...
class Func {
    ...
    template <typename F>
    static wasm_trap_t* raw_callback(void* env,
        ...
        Span<Val> results_span(reinterpret_cast<Val*>(results),  // NOLINT
                               nresults);
        Result<std::monostate, Trap> result = (*func)(Caller(caller), args_span, results_span);
        if (!result) {
    ...
    template <typename F>
    static wasm_trap_t* raw_callback_unchecked(void* env,
                                               wasmtime_caller_t* caller,
...
public:
    ...
    template <
        typename F,
        std::enable_if_t<std::is_invocable_r_v<Result<std::monostate, Trap>, F, Caller, Span<const Val>, Span<Val>>, bool> = true>
    Func(Store::Context cx, const FuncType& ty, F f) : func({}) {
        wasmtime_func_new(cx.ptr, ty.ptr.get(), raw_callback<F>, std::make_unique<F>(f).release(), raw_finalize<F>, &func);
    }
    ...
    static Func wrap(Store::Context cx, F f) {
        ...
        wasmtime_func_new_unchecked(
            cx.ptr, ty.ptr.get(), raw_callback_unchecked<F>, std::make_unique<F>(f).release(), raw_finalize<F>, &func);
        return func;
    }
    ...
    TrapResult<std::vector<Val>> call(Store::Context cx, const I& begin, const I& end) const {
        ...
        auto* error = wasmtime_func_call(
            cx.ptr, &func, raw_params.data(), raw_params.size(), raw_results.data(), raw_results.capacity(), &trap);
        if (error != nullptr) {
    ...
    FuncType type(Store::Context cx) const { return wasmtime_func_type(cx.ptr, &func); }
    ...
    Result<TypedFunc<Params, Results>, Trap> typed(Store::Context cx) const {
        ...
        if (!WasmTypeList<Params>::matches(ty->params()) || !WasmTypeList<Results>::matches(ty->results())) {
...
public:
    ...
    TrapResult<Results> call(Store::Context cx, Params params) const {
        std::array<wasmtime_val_raw_t, std::max(WasmTypeList<Params>::size, WasmTypeList<Results>::size)> storage;
        wasmtime_val_raw_t* ptr = storage.data();
        if (ptr == nullptr) ptr = reinterpret_cast<wasmtime_val_raw_t*>(alignof(wasmtime_val_raw_t));
        WasmTypeList<Params>::store(cx, ptr, params);
        wasm_trap_t* trap = nullptr;
        auto* error = wasmtime_func_call_unchecked(cx.raw_context(), &f.func, ptr, storage.size(), &trap);
        if (error != nullptr) {
            return TrapError(Error(error));
        }
        if (trap != nullptr) {
...
struct detail::WasmType<std::optional<Func>> {
    ...
    /// @private
    static void store(Store::Context cx, wasmtime_val_raw_t* p, const std::optional<Func> func) {
        if (func) {
...
public:
    ...
    GlobalType type(Store::Context cx) const { return wasmtime_global_type(cx.ptr, &global); }
...
public:
    ...
    TableType type(Store::Context cx) const { return wasmtime_table_type(cx.ptr, &table); }

    /// Returns the size, in elements, that the table currently has.
    uint64_t size(Store::Context cx) const { return wasmtime_table_size(cx.ptr, &table); }
...
public:
    ...
    MemoryType type(Store::Context cx) const { return wasmtime_memory_type(cx.ptr, &memory); }

    /// Returns the size, in WebAssembly pages, of this memory.
    uint64_t size(Store::Context cx) const { return wasmtime_memory_size(cx.ptr, &memory); }
...
public:
    ...
    explicit Linker(Engine& engine) : ptr(wasmtime_linker_new(engine.ptr.get())) {}

    /// Configures whether shadowing previous names is allowed or not.
    ///
    /// By default shadowing is not allowed.
    void allow_shadowing(bool allow) { wasmtime_linker_allow_shadowing(ptr.get(), allow); }
    ...
    Result<std::monostate> define(Store::Context cx, std::string_view module, std::string_view name, const Extern& item) {
        ...
        auto* error = wasmtime_linker_define(ptr.get(), cx.ptr, module.data(), module.size(), name.data(), name.size(), &raw);
        if (error != nullptr) {
            return Error(error);
        }
        return std::monostate();
    ...
    [[nodiscard]] std::optional<Extern> get(Store::Context cx, std::string_view module, std::string_view name) {
        wasmtime_extern_t item;
    ...
    Result<std::monostate> func_new(std::string_view module, std::string_view name, const FuncType& ty, F&& f) {
        auto* error = wasmtime_linker_define_func(ptr.get(),
                                                  module.data(),
                                                  module.length(),
                                                  name.data(),
                                                  name.length(),
                                                  ty.ptr.get(),
                                                  Func::raw_callback<std::remove_reference_t<F>>,
                                                  std::make_unique<std::remove_reference_t<F>>(std::forward<F>(f)).release(),
    ...
    Result<std::monostate> func_wrap(std::string_view module, std::string_view name, F&& f) {
        ...
        auto ty = FuncType::from_iters(params, results);
        auto* error =
            wasmtime_linker_define_func_unchecked(ptr.get(),
                                                  module.data(),
                                                  module.length(),
                                                  name.data(),
                                                  name.length(),
                                                  ty.ptr.get(),
                                                  Func::raw_callback_unchecked<std::remove_reference_t<F>>,
                                                  std::make_unique<std::remove_reference_t<F>>(std::forward<F>(f)).release(),
                                                  Func::raw_finalize<std::remove_reference_t<F>>);
