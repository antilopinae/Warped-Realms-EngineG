...
inline void from_json(const json& j, forcedRefsType& x) {
    if (j == "boolean")
        x = forcedRefsType::boolean;
    else if (j == "integer")
        x = forcedRefsType::integer;
    else if (j == "null")
        x = forcedRefsType::null;
    else if (j == "number")
        x = forcedRefsType::number;
    else if (j == "object")
        x = forcedRefsType::object;
    else if (j == "string")
        x = forcedRefsType::string;
    else {
...
inline void to_json(json& j, const forcedRefsType& x) {
    switch (x) {
        ...
        case forcedRefsType::string:
            ...
            break;
        default:
            throw std::runtime_error("Unexpected value in enumeration \"forcedRefsType\": " +
...
inline void from_json(const json& j, customCommandsType& x) {
    if (j == "array")
        x = customCommandsType::array;
    else if (j == "null")
        x = customCommandsType::null;
    else {
        throw std::runtime_error("Input JSON does not conform to schema!");
    }
}
...
inline void to_json(json& j, const customCommandsType& x) {
    switch (x) {
        ...
        case customCommandsType::null:
            ...
            break;
        default:
            throw std::runtime_error("Unexpected value in enumeration \"customCommandsType\": " +
                                     std::to_string(static_cast<int>(x)));
    }
}
}  // namespace quicktype
